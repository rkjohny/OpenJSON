#ifndef OPEN_JSON_REGISTER_GETTER_SETTER_H
#define OPEN_JSON_REGISTER_GETTER_SETTER_H

namespace open_json {

#define REGISTER_GETTER_START \
        static constexpr auto ms_getters = std::make_tuple(
...
#define REGISTER_SETTER_START \
        static constexpr auto ms_setters = std::make_tuple(
...
#define REGISTER_GETTER_INCLUDING_BASE_START(BASE_CLASS) \
        static constexpr auto ms_getters = std::tuple_cat(BASE_CLASS::ms_getters, std::make_tuple (
#define REGISTER_GETTER_INCLUDING_BASE_END ));

#define REGISTER_SETTER_INCLUDING_BASE_START(BASE_CLASS) \
        static constexpr auto ms_setters = std::tuple_cat(BASE_CLASS::ms_setters, std::make_tuple (
...
#endif //OPEN_JSON_REGISTER_GETTER_SETTER_H
